...
def split_data(X, yA, yB_high, yB_medium, yB_low, random_state=42):
    ...
    # 第二次划分：
    # 把剩下的 30% 平均分成 validation 和 test
    ...
    return {
        ...
        "yB_high_train": yB_high_train,
        "yB_high_val": yB_high_val,
        "yB_high_test": yB_high_test,

        "yB_medium_train": yB_medium_train,
        "yB_medium_val": yB_medium_val,
        "yB_medium_test": yB_medium_test,

        "yB_low_train": yB_low_train,
        "yB_low_val": yB_low_val,
        "yB_low_test": yB_low_test
    }
